...
<div id="chainstatus">
	<section>
		<div class="bg-gray-600 flex items-center px-3 py-1 rounded-2xl" id="chain_status">
			{#if !hasMetamask}
	...
	{#if !address}
		<button
			...
			class="bg-blue-500 text-white flex items-center px-3 py-1 rounded-2xl">Connect</button
		>
	{:else}
		<section>
			<div class="bg-gray-600 flex items-center px-3 py-1 rounded-2xl" id="wallet_address">
				{#if !address}
					<div class="dot bg-yellow-500" />
					Not connected
				{:else}
		...
		<section>
			<div class="bg-gray-600 flex items-center px-3 py-1 rounded-2xl" id="wallet_balance">
